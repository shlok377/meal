      ...
      {isOpen && (
        ...
        >
          <motion.div
            ...
            className={`relative w-full max-w-lg rounded-3xl p-6 sm:p-8 shadow-2xl border transition-colors duration-300 ${
              theme === 'dark'
            ...
            {!isOrdered ? (
              ...
              <div className="py-8 text-center space-y-4">
                ...
                <div className="pt-4">
                  <button
                    onClick={onClose}
                    className="px-8 py-2.5 rounded-full bg-neutral-900 dark:bg-neutral-100 text-white dark:text-neutral-900 font-sans font-semibold text-xs tracking-wider uppercase hover:opacity-90 transition-opacity cursor-pointer"
                  >
                    Back to Meal
                  </button>
                </div>
